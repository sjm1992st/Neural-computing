...
for t in mtime:      #Input current -uA
    ...
    syn_B=Synaptic_I2.cell_syn(t,A_v,B_v)
...
ax.set_yticks([-65.10,-64.99,-64.90,-64.85])
show()
#print Neuron_C.mv